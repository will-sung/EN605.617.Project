...
int main()
{
    ...
    save(buf, "tests/images/test_circle.png");
    delete[] buf;

    buf = make_canvas();
    draw_rect(buf, 131, 181, 381, 331, 200, 80, 80);
    save(buf, "tests/images/test_rect.png");
    delete[] buf;

    buf = make_canvas();
    draw_triangle(buf, 256, 110, 96, 400, 416, 400, 80, 180, 80);
    save(buf, "tests/images/test_triangle.png");
    delete[] buf;
    ...
    save(buf, "tests/images/test_circle_rect.png");
    delete[] buf;

    buf = make_canvas();
    draw_circle(buf,  128, 256, 90,  60, 120, 200);
    draw_triangle(buf, 384, 120, 270, 400, 498, 400, 80, 180, 80);
    save(buf, "tests/images/test_circle_tri.png");
    delete[] buf;

    buf = make_canvas();
    draw_rect(buf,    30, 185, 220, 325, 200, 80,  80);
    draw_triangle(buf, 384, 120, 270, 400, 498, 400, 80, 180, 80);
    save(buf, "tests/images/test_rect_tri.png");
    delete[] buf;
    ...
    save(buf, "tests/images/test_all.png");
    delete[] buf;
